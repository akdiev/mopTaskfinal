...
export default class Register extends Component {
    ...
    async handleSubmit(evt) {
      ...
      if ([emailError, passwordError].every(e => e === false)) {
        ...
        const response = await axios.post(this.state.api, {email: this.state.email.value, password: this.state.password.value, name: this.state.name.value, lastname: this.state.lastname.value});
    ...
    render() { 
      const { email, password, allFieldsValidated } = this.state;
        ...
        <Form className="content_custom" onSubmit={evt => this.handleSubmit(evt)}>
            ...
            <Form.Control className='field' name="name" type="text" placeholder="Name" onChange={evt =>
    ...
    <Form.Group controlId="Lastname">
            ...
            <Form.Control className={classnames('field','form-control',)} type="text" placeholder="Lastname" onChange={evt =>
